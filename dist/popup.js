...
function useChromeStorage(key, defaultValue) {
  ...
  const setStoredValue = reactExports.useCallback((newValue) => {
...
const useReaderSettings = () => {
  const [settings, setSettings] = useChromeStorage("readerSettings", DEFAULT_SETTINGS);
...
const Slider = ({ label, value, min, max, step = 1, onChange, unit = "" }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: label, className: "font-medium text-gray-300", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-2 py-1 text-xs font-mono bg-gray-700 rounded-md", children: [
        value,
        unit
      ] })
    ] }),
...
const App = () => {
  ...
  const toggleCountRef = reactExports.useRef(0);
  console.log("Current settings:", settings);
  const [isContentScriptActive, setIsContentScriptActive] = reactExports.useState(false);
  ...
  const sendMessageToContentScript = reactExports.useCallback((message) => {
    if (!isChromeApiAvailable) {
        ...
        chrome.scripting.executeScript({
          ...
          chrome.tabs.sendMessage(tabId, message, (response) => {
            if (chrome.runtime.lastError) {
              ...
              if (response.isScrolling !== void 0) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-gray-800 text-gray-100 space-y-6 w-72", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between pb-3 border-b border-gray-700", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold tracking-wider", children: "AutoScroll Reader" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-3 h-3 rounded-full ${isContentScriptActive ? "bg-green-400 animate-pulse" : "bg-red-500"}`, title: isContentScriptActive ? "Active" : "Inactive" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Slider,
        {
          label: "Scroll Speed",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-gray-300 mb-2", children: "Focus Line" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-gray-700/50 rounded-lg space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Slider,
            {
              label: "Thickness",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-around items-center pt-2", children: NEON_COLORS.map((color) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            ColorButton,
            {
              color,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "pt-3 border-t border-gray-700 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `w-full py-3 text-lg font-semibold rounded-lg transition-colors duration-200 ${settings.isScrolling ? "bg-red-600 hover:bg-red-700" : "bg-cyan-500 hover:bg-cyan-600"}`,
